...
const forgetPassword = (useremail, name, newPassword) => __awaiter(void 0, void 0, void 0, function* () {
    // checking if the user is exist
    const user = yield user_model_1.User.isUserExistsByEmail(useremail);
    if (user.name !== name) {
        throw new AppError_1.default(http_status_1.default.NOT_FOUND, 'This user is not found !');
    ...
    const resetToken = (0, auth_utils_1.createToken)(jwtPayload, config_1.default.jwt_refresh_secret, config_1.default.jwt_refresh_expires_in);
    return resetToken;
});
